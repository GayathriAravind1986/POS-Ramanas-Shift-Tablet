...
import 'package:posramanastab/Bloc/Authentication/login_bloc.dart';
...
import 'package:posramanastab/Reusable/customTextfield.dart';
import 'package:posramanastab/Reusable/responsive.dart';
import 'package:posramanastab/Reusable/space.dart';
import 'package:posramanastab/UI/ShiftClosing/shift_closing.dart';
            ...
            if (postLoginModel.success == true) {
              ...
              if (postLoginModel.user!.role == "OPERATOR") {
                Navigator.of(context).pushAndRemoveUntil(
                  MaterialPageRoute(builder: (context) => ShiftView()),
